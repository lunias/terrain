...
public class FastTag {
	...
	public static void main(String[] args) {
		if (args.length == 0) {
			...
			List<String> words = com.knowledgebooks.nlp.util.Tokenizer.wordsToList("Can I get some help with my computer? It's really slow lately.");
	...
	private static Map<String, String[]> buildLexicon() {
		...
		try {
			InputStream ins = new FileInputStream(ResourceUtils.getFile("classpath:lexicon.txt")); //FastTag.class.getClassLoader().getResourceAsStream("lexicon.txt");
			/*
			if (ins == null) {
